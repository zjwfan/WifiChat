...
import com.zjwfan.wifichat.util.InetAddressUtils;
...
public class WifiChatApplication extends Application {
    ...
    public static WifiChatApplication mainInstance;
...
//        crashHandler.init(getApplicationContext());
    ...
    public String getMyName() {
        return getSharedPreferences("me", 0).getString("name", "新用户");
    }
