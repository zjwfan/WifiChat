package com.zjwfan.wifichat.service;
...
import com.zjwfan.wifichat.listener.UDPMessageListener;
import com.zjwfan.wifichat.model.UDPMessage;
import com.zjwfan.wifichat.model.User;
import com.zjwfan.wifichat.ui.MainActivity;
import com.zjwfan.wifichat.ui.MessageChatActivity;
import com.zjwfan.wifichat.ui.RoomChatActivity;
	...
	public void onReceive(int type) {
		switch (type) {
			...
			case Listener.ASK_SEND_FILE:
				sendBroadcast(new Intent(MessageChatActivity.MessageUpdateBroadcastReceiver.ACTION_NOTIFY_DATA));
				break;
			case Listener.TO_ALL_MESSAGE:
				sendBroadcast(new Intent(RoomChatActivity.RoomChatBroadcastReceiver.ACTION_NOTIFY_DATA));
				break;
