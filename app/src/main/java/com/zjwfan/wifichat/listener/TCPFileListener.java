...
import com.zjwfan.wifichat.interfaces.OnTCPReceive;
...
public class TCPFileListener extends TCPListener implements OnTCPReceive {
	...
	public void onReceiveData(Socket socket) throws IOException {
		...
		if (filedir.indexOf("com.ty") == -1) {
			file = new File(WifiChatApplication.mainInstance.getFilePath() + fileName);
		} else {
		...
		if (WifiChatApplication.iconPath.equals(filedir) && iconReceived != null)
