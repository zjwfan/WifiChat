...
import com.zjwfan.wifichat.interfaces.IconReceived;
...
import com.zjwfan.wifichat.util.Constant;
import com.zjwfan.wifichat.util.LocalMemoryCache;
import com.zjwfan.wifichat.util.Util;
import com.zjwfan.wifichat.widget.PullToRefreshExpandableListView;


public class MainActivity extends BaseActivity implements IconReceived {
    ...
    public static ChatService.MyBinder binder;
    ...
    private void init() {
        ...
        listView.setOnChildClickListener(new OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Intent intent = new Intent(MainActivity.this, MessageChatActivity.class);
                switch (groupPosition) {
                    case 0:
                        String ip = WifiChatApplication.mainInstance.getLocalIp();
                        if (ip == null) {
                            showToast("请检测wifi");
                            return false;
                        }
                        ...
                        intent.putExtra("DeviceCode",
                                WifiChatApplication.mainInstance.getDeviceCode());
                        intent.putExtra("name",
                                WifiChatApplication.mainInstance.getMyName());
                        break;
                    case 1:
                        ...
                        break;
                    case 2:
                        intent = new Intent(MainActivity.this, RoomChatActivity.class);
                }
        ...
        listView.setOnRefreshListener(new PullToRefreshExpandableListView.OnRefreshListener() {
            @Override
    ...
    class MyAdapter extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, int childPosition,
            ...
            switch (groupPosition) {
                case 0:// 自己
                    holder.userName.setText(WifiChatApplication.mainInstance
                            .getMyName());
                    holder.ip.setText(WifiChatApplication.mainInstance.getLocalIp());
                    holder.msgNum.setVisibility(View.INVISIBLE);
                    Bitmap bitmap = LocalMemoryCache.getInstance().get(
                            SettingsActivity.iconName);
                    if (bitmap == null) {
                        bitmap = BitmapFactory
                                .decodeFile(WifiChatApplication.iconPath
                                        + SettingsActivity.iconName);
                        if (bitmap != null) {
                            holder.icon.setImageBitmap(Util
                                    .getRoundedCornerBitmap(bitmap));
                            LocalMemoryCache.getInstance().put(
                                    SettingsActivity.iconName, bitmap);
                        } else {
        ...
        private void reFreashIcon(User user, ImageView view) {
            if (binder != null)
                try {
                    UDPMessage message = WifiChatApplication.mainInstance
    ...
    public void iconReceived(String fileName) {
        ...
        if (msg != null) {
            Bitmap bitmap = BitmapFactory
                    .decodeFile(WifiChatApplication.iconPath + fileName);
            if (bitmap != null) {
